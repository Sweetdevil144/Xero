...
export default function ChatArea({
  ...
  return (
    <div className="flex-1 flex flex-col h-screen bg-white dark:bg-gray-900 relative">
      {/* Header */}
      <div className="sticky top-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700 px-4 py-3 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 max-w-2xl mx-auto">
                {[
                  ...
                  <button
                    ...
                    className="p-4 text-left border border-gray-200 dark:border-gray-600 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                  >
      ...
      {/* Input Area */}
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white dark:from-gray-900 via-white dark:via-gray-900 to-transparent">
            ...
            <form onSubmit={handleSubmit} className="relative">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute left-3 bottom-4 p-1.5 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors"
                  disabled={isLoading}
                  title="Attach file"
                >
